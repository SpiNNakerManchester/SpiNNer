...
# How big is each slot in a rack (not including spacing between slots) m
slot_width  = 1.5/100.0
slot_height = 24.0/100.0
slot_depth = 24.0/100.0

# Horizontal space between slots. m
...
# bottom-left corner of a slot or None to spread evenly over the slot. m
#wire_positions = None
wire_positions = {
